...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function applyHeroLanguage(lang){
    ...
    var meta=hero.querySelectorAll('.exif-hero-meta span');if(meta[0])meta[0].textContent=lang==='es'?'SEÑAL':'SIGNAL';if(meta[1])meta[1].textContent=lang==='es'?'MÉXICO + CARIBE':'MEXICO + CARIBBEAN';
  }
