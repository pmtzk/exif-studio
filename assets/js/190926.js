...
document.addEventListener('DOMContentLoaded',function(){
  ...
  var capabilities='VISUAL DIRECTION / BRANDING / WEBSITE / PHOTOGRAPHY / MOTION / CURATION / ';
  function capabilityRun(count){var out='';for(var i=0;i<count;i++)out+='<span>'+capabilities+'</span>';return out;}
  var capabilityFrame='<div class="capability-frame" aria-label="Visual Direction, Branding, Website, Photography, Motion, Curation"><div class="capability-edge capability-top"><div class="capability-run">'+capabilityRun(4)+'</div></div><div class="capability-edge capability-right"><div class="capability-run">'+capabilityRun(3)+'</div></div><div class="capability-edge capability-bottom"><div class="capability-run">'+capabilityRun(4)+'</div></div><div class="capability-edge capability-left"><div class="capability-run">'+capabilityRun(3)+'</div></div></div>';
  oldWork.outerHTML='<section class="gallery-chapter" id="selected-work" aria-label="Photography">'+capabilityFrame+'<div class="gallery-green-rise" aria-hidden="true"></div><div class="gallery-signal-stage" aria-hidden="true"><div class="gallery-signal"><span class="signal-dot signal-dot-ring-sm"></span><span class="signal-dot signal-dot-ring-md"></span><span class="signal-dot signal-dot-solid-md"></span><span class="signal-dot signal-dot-solid-lg"></span><span class="signal-dot signal-dot-solid-md"></span><span class="signal-dot signal-dot-ring-md"></span><span class="signal-dot signal-dot-ring-sm"></span></div></div><div class="motion-gallery-controls" aria-label="Gallery navigation"><button type="button" data-gallery-step="prev" aria-label="Previous images">←</button><button type="button" data-gallery-step="next" aria-label="Next images">→</button></div><div class="motion-gallery"><div class="motion-gallery-viewport"><div class="motion-gallery-track">'+galleryMarkup+'</div></div></div></section>';
});
